...
# install more !
echo 'phpmyadmin phpmyadmin/app-password-confirm password pooyaserver' | debconf-set-selections
echo 'phpmyadmin phpmyadmin/reconfigure-webserver multiselect apache2' | debconf-set-selections
echo 'phpmyadmin phpmyadmin/mysql/admin-pass password pooyaserver' | debconf-set-selections
echo 'phpmyadmin phpmyadmin/mysql/app-pass password pooyaserver' | debconf-set-selections
...
colorized_echo green "\n\tAll pooyaserver robot files/folders have been successfully installed on your server!"
...
dbname="pooyaserver_${randdbpass}"
...
config_address="/var/www/html/pooyaserverBot/install/pooya.install"
...
# touch('/var/www/html/pooyaserverBot/install/pooya.install')
echo "{\"development\":\"@pooyaserver\",\"install_location\":\"server\",\"main_domin\":\"${DOMAIN}\",\"token\":\"${TOKEN}\",\"dev\":\"${CHAT_ID}\",\"db_name\":\"${dbname}\",\"db_username\":\"${randdbdb}\",\"db_password\":\"${randdbpass}\"}" > /var/www/html/pooyaserverBot/install/pooya.install
...
curl --location "https://${DOMAIN}/pooyaserverBot/sql/sql.php?db_password=${dbpass}&db_name=${dbname}&db_username=${dbuser}"

colorized_echo blue "\n\nSet Webhook Status:"
curl -F "url=https://${DOMAIN}/pooyaserverBot/index.php" "https://api.telegram.org/bot${TOKEN}/setWebhook"

colorized_echo blue "\n\nSend Message Status:"
TEXT_MESSAGE="✅ The pooyaserver Bot Has Been Successfully Installed !"
curl -s -X POST "https://api.telegram.org/bot${TOKEN}/sendMessage" -d chat_id="${CHAT_ID}" -d text="${TEXT_MESSAGE}"
echo -e "\n\n"

sleep 1
colorized_echo green "[+] The pooyaserver Bot Has Been Successfully Installed"
